...
function UiSelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        selectTriggerVariants({ variant: variant as any }),
        className
      )}
      {...props}
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon
          className={cn(selectTriggerIconVariants({ variant: variant as any }))}
        />
...
function UiSelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn(
        selectLabelVariants({ variant: variant as any }),
        className
      )}
      {...props}
    />
...
function UiSelectItem({
  ...
  return (
    ...
    >
      <span
        className={cn(selectItemIndicatorVariants({ variant: variant as any }))}
      >
        <SelectPrimitive.ItemIndicator>
          <CheckIcon
            className={cn(
              selectItemIndicatorIconVariants({ variant: variant as any })
            )}
          />
        </SelectPrimitive.ItemIndicator>
      </span>
...
function UiSelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn(
        selectSeparatorVariants({ variant: variant as any }),
        className
      )}
      {...props}
    />
...
function UiSelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      className={cn(
        selectScrollButtonVariants({ variant: variant as any }),
        className
      )}
      {...props}
    >
      <ChevronUpIcon
        className={cn(
          selectScrollButtonIconVariants({ variant: variant as any })
        )}
      />
    </SelectPrimitive.ScrollUpButton>
  );
